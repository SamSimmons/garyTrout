...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] src/components/ViewInfo.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/home/sam/workspaces/garyTrout/src/components/ViewInfo.vue"
	  if (!module.hot.data) {
	...
	exports.default = {
		...
		methods: {
			...
			updateDatabase: function updateDatabase() {
				...
				_xhr2.default.post('/add', { json: (0, _stringify2.default)(this.trout) }, function (err, res) {
					if (err) {
						console.error(err);
					}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/sam/workspaces/garyTrout/src/components/Delete.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	  ...
	  ready: function ready() {
	    ...
	    _xhr2.default.get('/data', function (err, data) {
	      if (err) {
	        ...
	        _this.troutCollection = JSON.parse(data.body);
	        _this.troutCollection.forEach(_this.drawMarker);
	      }
	    });
	  },
	  data: function data() {
	  ...
	  methods: {
	    getTroutInfo: function getTroutInfo(evt) {
	      if (evt.srcElement.localName === 'circle') {
	        ...
	        this.trout = _lodash2.default.find(this.troutCollection, ['id', id]);
	      }
	    },
